...
comparing it against a gallery of images with a learned embedding model. Toggle between a
smaller and larger image gallery, and between a model trained specifically on this data versus
CLIP, a general-purpose off-the-shelf model.
